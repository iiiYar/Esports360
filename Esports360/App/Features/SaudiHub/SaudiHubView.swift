...
// MARK: - SaudiHubView — Phase-7
// ✔ NavigationStack removed — shell in AppRootView
// ✔ AppRoute typed nav: .team(id:) / .tournament(id:)
// ✔ E360StatusBanner replaces inline error + offline banner
// ✔ E360SkeletonList replaces SkeletonRow loop
// ✔ E360SectionHeader v2 replaces private SectionHeader
// ✔ NWPathMonitor + isOffline + clearError in ViewModel
// ✔ e360RowHighlight on team cards
    ...
    var body: some View {
        ScrollView(showsIndicators: false) {
            VStack(alignment: .leading, spacing: 22) {
                ...
                E360SectionHeader(
                    title: LocalizedStringKey("saudiHub.teams"),
                    badge: viewModel.isLoading ? nil
                        : "\(viewModel.teamProfiles.count)",
                    badgeColor: E360Color.gold,
                    icon: "flag.and.stars.fill",
                ...
                if viewModel.isLoading {
                    ...
                    VStack(spacing: 14) {
                        ForEach(viewModel.teamProfiles) { profile in
                            NavigationLink(value: AppRoute.team(id: profile.id)) {
                ...
                if let bracket = viewModel.featuredBracket {
                    NavigationLink(value: AppRoute.tournament(id: bracket.id)) {
            ...
            HStack {
                ...
                Image(systemName: "crown.fill")
                    ...
                    .foregroundStyle(LinearGradient(
                        colors: [E360Color.gold, .white], startPoint: .top, endPoint: .bottom))
                    .shadow(color: E360Color.gold.opacity(0.45), radius: 8)
            }

            Text(String(localized: "saudiHub.ewc",
                        defaultValue: "EWC · كأس العالم للرياضات الإلكترونية"))
    ...
    var body: some View {
        HStack(spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                HStack(spacing: 8) {
                    ESImageView(url: profile.displayGameImageURL,
...
// MARK: - SaudiHubViewModel
@MainActor
final class SaudiHubViewModel: ObservableObject {
    #if DEBUG
    ...
    private let monitorQueue = DispatchQueue(label: "com.esports360.network.saudihub")
    ...
    func load(forceRefresh: Bool = false) async {
        ...
        do {
            ...
            if teamProfiles.isEmpty { errorMessage = error.localizedDescription }
        }
    }
